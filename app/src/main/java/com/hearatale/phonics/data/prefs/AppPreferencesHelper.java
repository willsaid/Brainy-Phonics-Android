...
import com.hearatale.phonics.data.network.api.base.json.JsonArray;
import com.hearatale.phonics.data.network.api.base.json.JsonObject;
...
public class AppPreferencesHelper implements PreferencesHelper {
    ...
    public List<PieceModel> getPiecesCompletedByLetter(String letter) {
        ...
        if (mPref.contains(Constants.Preferences.SIMPLE_LETTERS + letter)) {
            ...
            if (!com.hearatale.phonics.utils.Helper.isListValid(listPiecesCompleted)) {
